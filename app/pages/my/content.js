                ...
                <View style={styles.myNote}>
                    <View style={styles.noteUserBox}>
                        <View style={[styles.portrait, {borderRadius:31}]}>
                            <Image source={{uri: data.user.thumbUri, width: 31, height: 31}} style={{borderRadius:15.5}}/>
                        </View>
                    ...
                    <TouchableHighlight>
                        <View style={styles.noteThumbBox}>
                            <Image style={styles.noteThumb} source={{uri: data.detail.image ,width: 191, height: 191}} resizeMode={Image.resizeMode.contain} />
                        </View>
                    </TouchableHighlight>
